...
pub enum MoveTypeLayout {
    ...
    #[serde(rename(serialize = "auth", deserialize = "auth"))]
    Auth,
}
...
impl<'d> serde::de::DeserializeSeed<'d> for &MoveTypeLayout {
    ...
    fn deserialize<D: serde::de::Deserializer<'d>>(
        ...
        match self {
            ...
            MoveTypeLayout::Auth => AccountAddress::deserialize(deserializer).map(MoveValue::Auth),
...
impl serde::Serialize for MoveValue {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        match self {
            ...
            MoveValue::Auth(a) => a.serialize(serializer),
        }
    }
}
...
impl TryInto<TypeTag> for &MoveTypeLayout {
    ...
    fn try_into(self) -> Result<TypeTag, Self::Error> {
        Ok(match self {
            ...
            MoveTypeLayout::Auth => TypeTag::Auth,
        })
    }
}
...
impl fmt::Display for MoveValue {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            MoveValue::Auth(a) => write!(f, "auth({})", a),
        }
    }
}
