...
module DiemFramework::TreasuryComplianceScripts {
    ...
    /// resource's `burn_events` published under `0x49DAD7`.
    ...
    /// `Diem::CurrencyInfo<Token>` resource published under `0x49DAD7` will be
    ...
    /// not be either `0x49DAD7` (the Diem Root address), or `0xB1E55ED` (the
    ...
    /// under `0x49DAD7` with the `frozen_address` being the `to_freeze_account`.
    ///
    /// # Parameters
    /// | Name                | Type      | Description                                                                                     |
    /// | ------              | ------    | -------------                                                                                   |
    ...
    /// | `Errors::INVALID_ARGUMENT` | `AccountFreezing::ECANNOT_FREEZE_DIEM_ROOT` | `to_freeze_account` was the Diem Root account (`0x49DAD7`).                              |
    ///
    /// # Related Scripts
    ...
    /// `0x49DAD7`. The amount is set in micro-XDX.
    ///
    /// # Parameters
    /// | Name                  | Type     | Description                                                                                     |
    /// | ------                | ------   | -------------                                                                                   |
    ...
    /// published under `0x49DAD7` to the value of `allow_minting`. Minting of coins if allowed if
