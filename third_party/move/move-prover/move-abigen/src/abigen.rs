                    ...
                    func.is_entry()
                        ...
                        && func
                            ...
                            .skip_while(|param| match &param.1 {
                                ty::Type::Primitive(
                                    ty::PrimitiveType::Signer | ty::PrimitiveType::Auth,
                                ) => true,
    ...
    fn generate_abi_for_function(
        ...
        let args = func
            ...
            .filter(|param| match &param.1 {
                ty::Type::Primitive(ty::PrimitiveType::Signer | ty::PrimitiveType::Auth) => false,
                ty::Type::Reference(ReferenceKind::Immutable, inner) => !matches!(
                    &**inner,
                    ty::Type::Primitive(ty::PrimitiveType::Signer | ty::PrimitiveType::Auth)
                ),
                ty::Type::Vector(inner) => !matches!(
                    &**inner,
                    ty::Type::Primitive(ty::PrimitiveType::Signer | ty::PrimitiveType::Auth)
