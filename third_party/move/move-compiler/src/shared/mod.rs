...
pub fn warn_of_deprecation_use_in_endless_libs_env_var() -> bool {
    static WARN_OF_DEPRECATION: Lazy<bool> =
        Lazy::new(|| read_bool_env_var(cli::WARN_OF_DEPRECATION_USE_IN_ENDLESS_LIBS));
    *WARN_OF_DEPRECATION
}

pub fn warn_of_deprecation_use_in_endless_libs_env_var_str() -> &'static str {
    if warn_of_deprecation_use_in_endless_libs_env_var() {
        "true"
    } else {
        "false"
    }
...
pub struct Flags {
    ...
    /// Show warnings about use of deprecated usage in the Endless libraries,
    /// which we should generally not bother users with.
    /// Note that current value of this constant is "Wdeprecation-endless"
    #[clap(long = cli::WARN_OF_DEPRECATION_USE_IN_ENDLESS_LIBS_FLAG, default_value=warn_of_deprecation_use_in_endless_libs_env_var_str())]
    warn_of_deprecation_use_in_endless_libs: bool,
...
impl Flags {
    pub fn empty() -> Self {
        Self {
            ...
            warn_of_deprecation_use_in_endless_libs:
                warn_of_deprecation_use_in_endless_libs_env_var(),
            warn_unused: false,
            v2: false,
        }
    }
    ...
    pub fn warn_of_deprecation_use_in_endless_libs(&self) -> bool {
        self.warn_of_deprecation_use_in_endless_libs
    }

    pub fn set_warn_of_deprecation_use_in_endless_libs(self, new_value: bool) -> Self {
        Self {
            warn_of_deprecation_use_in_endless_libs: new_value,
            ..self
        }
    }
...
pub mod known_attributes {
    ...
    pub enum KnownAttribute {
        ...
        LegacyEntryFunction(LegacyEntryFunctionAttribute),
        ResourceGroup(ResourceGroupAttribute),
        ViewFunction(ViewFunctionAttribute),
    ...
    #[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord)]
    pub enum LegacyEntryFunctionAttribute {
        LegacyEntryFunction,
    }

    #[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord)]
    pub enum ResourceGroupAttribute {
        ResourceGroup,
        ResourceGroupMember,
    }

    #[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord)]
    pub enum ViewFunctionAttribute {
        ViewFunction,
    }
    ...
    impl AttributeKind for KnownAttribute {
        fn add_attribute_names(table: &mut BTreeSet<String>) {
            ...
            LegacyEntryFunctionAttribute::add_attribute_names(table);
            ResourceGroupAttribute::add_attribute_names(table);
            ViewFunctionAttribute::add_attribute_names(table);
        ...
        fn name(&self) -> &str {
            match self {
                ...
                Self::LegacyEntryFunction(a) => a.name(),
                Self::ResourceGroup(a) => a.name(),
                Self::ViewFunction(a) => a.name(),
                Self::Event(a) => a.name(),
            }
        }
        ...
        fn expected_positions(&self) -> &'static BTreeSet<AttributePosition> {
            match self {
                ...
                Self::LegacyEntryFunction(a) => a.expected_positions(),
                Self::ResourceGroup(a) => a.expected_positions(),
                Self::ViewFunction(a) => a.expected_positions(),
    ...
    impl LegacyEntryFunctionAttribute {
        const ALL_ATTRIBUTE_NAMES: [&'static str; 1] = [Self::LEGACY_ENTRY_FUNCTION];
        pub const LEGACY_ENTRY_FUNCTION: &'static str = "legacy_entry_function";
    }

    impl AttributeKind for LegacyEntryFunctionAttribute {
        fn add_attribute_names(table: &mut BTreeSet<String>) {
            for str in Self::ALL_ATTRIBUTE_NAMES {
                table.insert(str.to_string());
            }
        ...
        fn name(&self) -> &str {
            Self::LEGACY_ENTRY_FUNCTION
        }

        fn expected_positions(&self) -> &'static BTreeSet<AttributePosition> {
            static LEGACY_ENTRY_FUNCTION_POSITIONS: Lazy<BTreeSet<AttributePosition>> =
                Lazy::new(|| IntoIterator::into_iter([AttributePosition::Function]).collect());
            &LEGACY_ENTRY_FUNCTION_POSITIONS
        }
    }

    impl ResourceGroupAttribute {
        const ALL_ATTRIBUTE_NAMES: [&'static str; 2] =
            [Self::RESOURCE_GROUP, Self::RESOURCE_GROUP_MEMBER];
        pub const RESOURCE_GROUP: &'static str = "resource_group";
        pub const RESOURCE_GROUP_MEMBER: &'static str = "resource_group_member";
    }

    impl AttributeKind for ResourceGroupAttribute {
        fn add_attribute_names(table: &mut BTreeSet<String>) {
            for str in Self::ALL_ATTRIBUTE_NAMES {
                table.insert(str.to_string());
            }
        ...
        fn name(&self) -> &str {
            match self {
                Self::ResourceGroup => Self::RESOURCE_GROUP,
                Self::ResourceGroupMember => Self::RESOURCE_GROUP_MEMBER,
            }
        }

        fn expected_positions(&self) -> &'static BTreeSet<AttributePosition> {
            static RESOURCE_GROUP_POSITIONS: Lazy<BTreeSet<AttributePosition>> =
                Lazy::new(|| IntoIterator::into_iter([AttributePosition::Struct]).collect());
            &RESOURCE_GROUP_POSITIONS
        }
    }

    impl ViewFunctionAttribute {
        const ALL_ATTRIBUTE_NAMES: [&'static str; 1] = [Self::VIEW_FUNCTION];
        pub const VIEW_FUNCTION: &'static str = "view";
    }

    impl AttributeKind for ViewFunctionAttribute {
        fn add_attribute_names(table: &mut BTreeSet<String>) {
            for str in Self::ALL_ATTRIBUTE_NAMES {
                table.insert(str.to_string());
            }
        ...
        fn expected_positions(&self) -> &'static BTreeSet<AttributePosition> {
            static VIEW_FUNCTION_POSITIONS: Lazy<BTreeSet<AttributePosition>> =
                Lazy::new(|| IntoIterator::into_iter([AttributePosition::Function]).collect());
            &VIEW_FUNCTION_POSITIONS
        }
    }

    impl EventAttribute {
        const ALL_ATTRIBUTE_NAMES: [&'static str; 1] = [Self::EVENT];
