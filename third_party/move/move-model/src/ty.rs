...
impl PrimitiveType {
    ...
    pub fn is_spec(&self) -> bool {
        use PrimitiveType::*;
        match self {
            Bool | U8 | U16 | U32 | U64 | U128 | U256 | Address | Signer | Auth => false,
...
impl Type {
    ...
    pub fn from_type_tag(t: &TypeTag, env: &GlobalEnv) -> Self {
        ...
        match t {
            ...
            TypeTag::Auth => Primitive(PrimitiveType::Auth),
            TypeTag::Struct(s) => {
    ...
    H: Fn(&Loc, &str) + Copy,
{
    match ty {
        Type::Primitive(p) => match p {
            ...
            PrimitiveType::Auth => AbilitySet::AUTH,
        },
