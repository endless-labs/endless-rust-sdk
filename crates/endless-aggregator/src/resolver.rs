...
use crate::{
    ...
    types::{
        code_invariant_error, DelayedFieldCompare, DelayedFieldValue,
        DelayedFieldsSpeculativeError, DeltaApplicationFailureReason, PanicOr,
    },
};
use endless_types::{
    ...
    S: StateView,
{
    ...
    fn delayed_field_compare(
        ...
        _id: &Self::Identifier,
        _base_delta: &SignedU128,
        _method: DelayedFieldCompare,
        _other: u128,
        _max_value: u128,
    ) -> Result<bool, PanicOr<DelayedFieldsSpeculativeError>> {
        unimplemented!("delayed_field_compare not implemented")
    }
