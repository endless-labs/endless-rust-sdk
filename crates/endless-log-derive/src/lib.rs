...
pub fn derive(input: TokenStream) -> TokenStream {
    ...
    let from_serde = quote! { ::endless_logger::Value::from_serde };
    let from_display = quote! { ::endless_logger::Value::from_display };
    let from_debug = quote! { ::endless_logger::Value::from_debug };
    let key_new = quote! { ::endless_logger::Key::new };
    ...
    let expanded = quote! {
        ...
        impl #impl_generics ::endless_logger::Schema for #name #ty_generics #where_clause {
            fn visit(&self, visitor: &mut dyn ::endless_logger::Visitor) {
                #(#visits)*
            }
        }
    };
