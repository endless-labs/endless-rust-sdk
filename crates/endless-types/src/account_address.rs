...
const MULTISIG_ACCOUNT_DOMAIN_SEPARATOR: &[u8] = b"endless_framework::multisig_account";
const STAKING_CONTRACT_DOMAIN_SEPARATOR: &[u8] = b"endless_framework::staking_contract";
const VESTING_POOL_DOMAIN_SEPARATOR: &[u8] = b"endless_framework::vesting";
...
// See this issue for potential improvements: https://github.com/endless-labs/endless-core/issues/3960
...
mod hasher {
    #[derive(serde::Deserialize, endless_crypto_derive::CryptoHasher)]
...
mod test {
    ...
    use endless_crypto::hash::HashValue;
    use hex::FromHex;
    ...
    fn address_hash() {
        ...
        let hash_vec =
            &Vec::from_hex("e4fd83c358a6e73493cd2c4e53055c67c3283949baa1b0cbc5f083cf723ca57c")
