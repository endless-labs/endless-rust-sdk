...
pub enum NamedChain {
    ...
    /// initialization.
    /// MAINNET is the Endless mainnet production chain and is reserved for 1
    MAINNET = 220,
...
impl NamedChain {
    ...
    pub fn from_chain_id(chain_id: &ChainId) -> Result<NamedChain, String> {
        ...
        match chain_id {
            220 => Ok(NamedChain::MAINNET),
            221 => Ok(NamedChain::TESTNET),
            222 => Ok(NamedChain::DEVNET), // TODO: this is not correct and should removed. The devnet chain ID changes.
            223 => Ok(NamedChain::TESTING),
            224 => Ok(NamedChain::PREMAINNET),
