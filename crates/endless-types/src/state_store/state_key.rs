...
use endless_crypto_derive::CryptoHasher;
...
mod tests {
    ...
    use endless_crypto::hash::CryptoHash;
    use move_core_types::language_storage::ModuleId;

    #[test]
    fn test_access_path_hash() {
        let key = StateKey::access_path(AccessPath::new("0x1002".parse().unwrap(), vec![7, 2, 3]));
        let expected_hash = "b74b073586b39ac960e36e1d5394be5d196079d9b54daf682c16afa88711b751"
            .parse()
            .unwrap();
    ...
    fn test_table_item_hash() {
        ...
        let expected_hash = "a11db48fda878902d06a1dc99cf42171c6ade01084db93846b18628d162d3b86"
            .parse()
            .unwrap();
        assert_eq!(CryptoHash::hash(&key), expected_hash);
    }
    ...
    fn test_raw_hash() {
        ...
        let expected_hash = "e871b34ac2cbf27f2fe7aa2779ad350aa65213ebe496a376005500b9bd715f3f"
            .parse()
            .unwrap();
        assert_eq!(CryptoHash::hash(&key), expected_hash);
    }
    ...
    fn test_debug() {
        ...
        assert_eq!(
            &format!("{:?}", key),
            "StateKey { inner: Raw(010203), hash: OnceCell(HashValue(e871b34ac2cbf27f2fe7aa2779ad350aa65213ebe496a376005500b9bd715f3f)) }"
        );
    }
}
