...
#[cfg(test)]
pub fn generate_approximate_zipf(size: usize, a: u128, b: u128, exponent: f64) -> Vec<u128> {
    ...
    (0..size)
        .map(|_| {
            ...
            let approximate_value =
                a + ((b - a + 1) as f64 * (1.0 - random_uniform).powf(exponent)) as u128;
...
#[cfg(test)]
pub const MAINNET_STAKES: [u128; 112] = [
    210500217584363000,
    19015034427309200,
    190269409955015000,
    190372712607660000,
