...
use endless_crypto::{bls12381, bls12381::PrivateKey};
use endless_dkg::{
    pvss,
    pvss::{
...
pub fn build_dkg_pvss_config(
    ...
    let validator_stakes: Vec<u128> = next_validators.iter().map(|vi| vi.voting_power).collect();
    ...
    DKGPvssConfig::new(cur_epoch, dkg_rounding.wconfig, pp, consensus_keys)
}
