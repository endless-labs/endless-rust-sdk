...
pub use endless_cached_packages::endless_stdlib;
use endless_crypto::{ed25519::Ed25519PublicKey, HashValue};
use endless_global_constants::{GAS_UNIT_PRICE, MAX_GAS_AMOUNT};
use endless_types::transaction::{EntryFunction, Script};
...
impl TransactionFactory {
    ...
    pub fn safe_entry_function(
        &self,
        func: EntryFunction,
        payment_checksum: HashValue,
    ) -> TransactionBuilder {
        self.payload(TransactionPayload::SafeEntryFunction(
            func,
            payment_checksum,
        ))
    }
    ...
    pub fn create_user_account(&self, public_key: &Ed25519PublicKey) -> TransactionBuilder {
        self.payload(endless_stdlib::endless_account_create_account(
    ...
    pub fn implicitly_create_user_account_and_transfer(
        ...
        self.payload(endless_stdlib::endless_account_transfer(
            AuthenticationKey::ed25519(public_key).account_address(),
            amount,
        ))
    }

    pub fn transfer(&self, to: AccountAddress, amount: u128) -> TransactionBuilder {
        self.payload(endless_stdlib::endless_coin_transfer(to, amount))
    }

    pub fn account_transfer(&self, to: AccountAddress, amount: u128) -> TransactionBuilder {
        self.payload(endless_stdlib::endless_account_transfer(to, amount))
    }
    ...
    // ) -> TransactionBuilder {
    //     self.payload(endless_stdlib::multisig_account_create_with_owners(
    //         additional_owners,
    //         signatures_required,
    //         vec![],
    //         vec![],
    ...
    pub fn create_multisig_transaction(
        ...
        self.payload(endless_stdlib::multisig_account_create_transaction(
            multisig_account,
            payload,
        ))
    }
    ...
    pub fn approve_multisig_transaction(
        ...
        self.payload(endless_stdlib::multisig_account_approve_transaction(
            multisig_account,
            transaction_id,
        ))
    }
    ...
    pub fn reject_multisig_transaction(
        ...
        self.payload(endless_stdlib::multisig_account_reject_transaction(
            multisig_account,
            transaction_id,
        ))
    }
    ...
    pub fn create_multisig_transaction_with_payload_hash(
        ...
        self.payload(
            endless_stdlib::multisig_account_create_transaction_with_hash(
                multisig_account,
    ...
    pub fn mint(&self, to: AccountAddress, amount: u128) -> TransactionBuilder {
        self.payload(endless_stdlib::endless_coin_mint(to, amount))
    }
    ...
    pub fn safe_script(&self, script: Script, payment_checksum: HashValue) -> TransactionBuilder {
        self.payload(TransactionPayload::SafeScript(script, payment_checksum))
    }
