...
use bytes::Bytes;
use endless_gas_algebra::DynamicExpression;
use endless_gas_schedule::{MiscGasParameters, NativeGasParameters, ToOnChainGasSchedule};
use endless_types::on_chain_config::{Features, TimedFeatures};
...
impl SafeNativeBuilder {
    ...
    ///
    /// The closure will have access to the common Endless configurations (features, gas params etc.),
