...
//! This module defines the gas parameters for Endless Framework & Stdlib.

use crate::gas_schedule::NativeGasParameters;
use endless_gas_algebra::{
    InternalGas, InternalGasPerAbstractValueUnit, InternalGasPerArg, InternalGasPerByte,
};

crate::gas_schedule::macros::define_gas_parameters!(
    EndlessFrameworkGasParameters,
    "endless_framework",
    NativeGasParameters => .endless_framework,
    [
        ...
        [transaction_context_sender_base: InternalGas, { 12.. => "transaction_context.sender.base"}, 735],
        [transaction_context_secondary_signers_base: InternalGas, { 12.. => "transaction_context.secondary_signers.base"}, 735],
        [transaction_context_secondary_signers_per_signer: InternalGasPerArg, { 12.. => "transaction_context.secondary_signers.per_signer"}, 576], // 18 * 32
        [transaction_context_fee_payer_base: InternalGas, { 12.. => "transaction_context.fee_payer.base"}, 735],
        [transaction_context_max_gas_amount_base: InternalGas, { 12.. => "transaction_context.max_gas_amount.base"}, 735],
        [transaction_context_gas_unit_price_base: InternalGas, { 12.. => "transaction_context.gas_unit_price.base"}, 735],
        [transaction_context_chain_id_base: InternalGas, { 12.. => "transaction_context.chain_id.base"}, 735],
        [transaction_context_entry_function_payload_base: InternalGas, { 12.. => "transaction_context.entry_function_payload.base"}, 735],
        [transaction_context_entry_function_payload_per_byte_in_str: InternalGasPerByte, { 12.. => "transaction_context.entry_function_payload.per_abstract_memory_unit"}, 18],
        [transaction_context_multisig_payload_base: InternalGas, { 12.. => "transaction_context.multisig_payload.base"}, 735],
        [transaction_context_multisig_payload_per_byte_in_str: InternalGasPerByte, { 12.. => "transaction_context.multisig_payload.per_abstract_memory_unit"}, 18],
        ...
        [aggregator_v2_compare_base: InternalGas, {12.. => "aggregator_v2.compare.base"}, 500],
        ...
        // These are dummy value, they copied from storage gas in endless-core/endless-vm/src/endless_vm_impl.rs
