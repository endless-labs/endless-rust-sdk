...
//! see the [coding guidelines](https://endless.dev/docs/core/coding-guidelines#logging).
//!
...
//!
//! ```
//! use endless_logger::{info, Schema};
//!
//! #[derive(Schema)]
//! struct LogSchema<'a> {
...
//!
//! ```
//! use endless_logger::{info, sample, sample::{SampleRate, Sampling}};
...
//!
//! ```
//! use endless_logger::{Level, Logger};
//!
...
pub use crate::endless_logger::{
    EndlessData as Logger, EndlessDataBuilder, LoggerFilterUpdater, Writer, CHANNEL_SIZE,
};
pub use endless_log_derive::Schema;
pub use event::Event;
