...
pub const BCS_VIEW_FUNCTION: &str = "application/x.endless.view_function+bcs";

pub const BCS_SIGNED_TRANSACTION: &str = "application/x.endless.signed_transaction+bcs";
