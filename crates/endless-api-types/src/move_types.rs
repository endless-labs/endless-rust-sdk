...
use endless_types::{account_config::CORE_CODE_ADDRESS, event::EventKey, transaction::Module};
use indoc::indoc;
...
impl_poem_type!(
    ...
    (
        ...
        description = Some(indoc! {"
            ...
            Move `address` type value (32 byte Endless account address) is serialized into a HexEncodedBytes string.
            For example:
              - `0x1`
            ...
            For example:
              `{ \"created\": \"0x49dad7\", \"role_id\": \"0\" }`

            **Special serialization for Move stdlib types**:
              - [0x1::string::String](https://github.com/endless-labs/endless-core/blob/main/language/move-stdlib/docs/ascii.md)
...
impl_poem_type!(
    ...
    (
        example = Some(serde_json::Value::String(
            "0x1::coin::CoinStore<0x1::endless_coin::EndlessCoin>".to_string()
        )),
        ...
        Examples:
          * `0x1::coin::CoinStore<0x1::endless_coin::EndlessCoin>`
          * `0x1::account::Account`
        ...
        See [doc](https://endless.dev/concepts/accounts) for more details.
      "})
    )
);
impl_poem_parameter!(MoveStructTag);
...
impl MoveType {
    ...
    pub fn json_type_name(&self) -> String {
        match self {
            ...
            MoveType::Auth => "string<auth>".to_owned(),
...
impl_poem_type!(
    ...
    (
        pattern = Some(
            "^(bool|u8|u64|u128|address|signer|auth|vector<.+>|0x[0-9a-zA-Z:_<, >]+)$".to_string()
        ),
        description = Some(indoc! {"
...
impl_poem_type!(
    ...
    "string",
    (
        example = Some(serde_json::Value::String("0x1::endless_coin".to_string())),
        description = Some(indoc! {"
...
impl_poem_type!(
    ...
    (
        example = Some(serde_json::Value::String(
            "0x1::endless_coin::transfer".to_string()
        )),
        description = Some(indoc! {"
...
mod tests {
        ...
        assert_json(
            ...
            json!({
                ...
                "data": {
                    ...
                    "field_u128": "7",
                    "field_bool": true,
                    "field_address": "11111111111111111111111111111114p",
                    "field_vector": ["128"],
                    "field_bytes": "0x0909",
                    "field_struct": {
                        "nested_vector": [{"address1": "0x0", "address2": "11111111111111111111111111111162"}]
                    },
                }
            }),
        );
    ...
    fn test_parse_invalid_move_module_id_string() {
        ...
        assert_eq!(
            "Invalid Move module ID: Endless::Endless",
            "Endless::Endless"
                .parse::<MoveModuleId>()
                .err()
                .unwrap()
        ...
        assert_eq!(
            "Invalid Move module ID: 0x1::Endless::Endless",
            "0x1::Endless::Endless"
                .parse::<MoveModuleId>()
                .err()
                .unwrap()
    ...
    fn test_parse_invalid_move_entry_function_id_string() {
        ...
        assert_eq!(
            "Invalid entry function ID Endless::Endless",
            "Endless::Endless"
                .parse::<EntryFunctionId>()
                .err()
                .unwrap()
        ...
        assert_eq!(
            "Invalid entry function ID 0x1::Endless::Endless::Endless",
            "0x1::Endless::Endless::Endless"
                .parse::<EntryFunctionId>()
                .err()
                .unwrap()
                .to_string()
