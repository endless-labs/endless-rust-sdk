...
use endless_gas_schedule::EndlessGasParameters;
...
impl ChangeSetConfigs {
    ...
    pub fn new(feature_version: u64, gas_params: &EndlessGasParameters) -> Self {
    ...
    pub fn legacy_resource_creation_as_modification(&self) -> bool {
        ...
        // modification.
        // Modules and table items were not affected (https://github.com/endless-labs/endless-core/pull/4722/commits/7c5e52297e8d1a6eac67a68a804ab1ca2a0b0f37).
    ...
    fn from_gas_params(gas_feature_version: u64, gas_params: &EndlessGasParameters) -> Self {
