...
id: crypto
title: Crypto
custom_edit_url: https://github.com/endless-labs/endless-core/edit/main/crypto/crypto/README.md
---

The crypto component hosts all the implementations of cryptographic primitives we use in Endless: hashing, signatures, multisignatures, aggregate signatures, and key derivation/generation.
...
Endless makes use of several cryptographic algorithms:
