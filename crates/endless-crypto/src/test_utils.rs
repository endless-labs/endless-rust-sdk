...
) -> impl Strategy<Value = (EdwardsPoint, EdwardsPoint, TestEndlessCrypto)> {
    (
...
pub struct TestEndlessCrypto(pub String);
...
// #[cfg(any(test, feature = "fuzzing"))]
pub struct TestEndlessCryptoHasher(crate::hash::DefaultHasher);
// #[cfg(any(test, feature = "fuzzing"))]
impl ::core::clone::Clone for TestEndlessCryptoHasher {
    #[inline]
    fn clone(&self) -> TestEndlessCryptoHasher {
        match *self {
            TestEndlessCryptoHasher(ref __self_0_0) => {
                TestEndlessCryptoHasher(::core::clone::Clone::clone(__self_0_0))
            },
        }
    }
}
...
// #[cfg(any(test, feature = "fuzzing"))]
impl TestEndlessCryptoHasher {
    fn new() -> Self {
        let name = crate::_serde_name::trace_name::<TestEndlessCrypto>()
            .expect("The `CryptoHasher` macro only applies to structs and enums");
        TestEndlessCryptoHasher(crate::hash::DefaultHasher::new(name.as_bytes()))
    }
}
// #[cfg(any(test, feature = "fuzzing"))]
static TEST_CRYPTO_HASHER: crate::_once_cell::sync::Lazy<TestEndlessCryptoHasher> =
    crate::_once_cell::sync::Lazy::new(TestEndlessCryptoHasher::new);
// #[cfg(any(test, feature = "fuzzing"))]
impl std::default::Default for TestEndlessCryptoHasher {
    fn default() -> Self {
        TEST_CRYPTO_HASHER.clone()
    }
}
// #[cfg(any(test, feature = "fuzzing"))]
impl crate::hash::CryptoHasher for TestEndlessCryptoHasher {
...
// #[cfg(any(test, feature = "fuzzing"))]
impl std::io::Write for TestEndlessCryptoHasher {
...
// #[cfg(any(test, feature = "fuzzing"))]
impl crate::hash::CryptoHash for TestEndlessCrypto {
    type Hasher = TestEndlessCryptoHasher;

    fn hash(&self) -> crate::hash::HashValue {
        use crate::hash::CryptoHasher;
        let mut state = Self::Hasher::default();
        bcs::serialize_into(&mut state, &self)
            .expect("BCS serialization of TestEndlessCrypto should not fail");
        state.finish()
    }
}

/// Produces a random TestEndlessCrypto signable / verifiable struct.
#[cfg(any(test, feature = "fuzzing"))]
pub fn random_serializable_struct() -> impl Strategy<Value = TestEndlessCrypto> {
    (String::arbitrary())
        .prop_map(TestEndlessCrypto)
        .no_shrink()
}
