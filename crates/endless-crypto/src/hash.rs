...
//! use the derive macros of `serde` and `endless_crypto_derive` as follows:
//! ```
...
//!
//! ```
//! use endless_crypto::hash::{CryptoHasher, TestOnlyHasher};
//!
...
pub(crate) const HASH_PREFIX: &[u8] = b"ENDLESS::";
...
impl HashValue {
    ...
    #[cfg(test)]
    /// Creates a `HashValue` from an iterator of buffers.
    ...
    /// Base58 representation of a given hash value.
...
/// # Example
/// ```
/// use endless_crypto::hash::TestOnlyHash;
///
