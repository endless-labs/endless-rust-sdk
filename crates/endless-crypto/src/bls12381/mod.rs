...
//! ```
//! use std::iter::zip;
//! use endless_crypto::test_utils::{KeyPair, TestEndlessCrypto};
//! use endless_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use endless_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use endless_crypto::bls12381::ProofOfPossession;
//! use endless_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
...
//! //
//! // Here, we'll sign an existing testing struct from `crates/endless-crypto/src/test_utils.rs`:
//! //
...
//! use endless_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use endless_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use endless_crypto::bls12381::{ProofOfPossession, UnvalidatedPublicKey};
//! use endless_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
//! use serde::{Serialize, Deserialize};
//! use endless_crypto::validatable::Validatable;
//!
//! // NOTE: These were generated by running `cargo test -- doc_test --ignored --nocapture` in `crates/endless-crypto/`
...
//! // signature on TestEndlessCrypto("test".to_owned())
...
//! ```
//! use std::iter::zip;
//! use endless_crypto::test_utils::KeyPair;
//! use endless_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use endless_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use endless_crypto::bls12381::ProofOfPossession;
//! use endless_crypto_derive::{CryptoHasher, BCSCryptoHash};
