...
fn quote_type_as_format(type_tag: &TypeTag) -> Format {
    ...
    match type_tag {
        ...
        Auth => type_not_allowed(type_tag),
    }
}
...
pub(crate) fn get_external_definitions(endless_types: &str) -> serde_generate::ExternalDefinitions {
    let definitions = vec![(endless_types, vec![
        "AccountAddress",
        "TypeTag",
        "Script",
        "TransactionArgument",
