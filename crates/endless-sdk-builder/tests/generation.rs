...
use endless_sdk_builder as buildgen;
...
fn get_endless_registry() -> Registry {
    let path = "../../testsuite/generate-format/tests/staged/endless.yaml";
...
[dependencies]
endless-types = {{ path = "../endless-types", version = "0.1.0" }}
serde_bytes = "0.11.6"
serde = {{ version = "1.0.114", features = ["derive"] }}
bcs = {{ git = "https://github.com/endless-labs/bcs", rev = "2cde3e8446c460cb17b0c1d6bac7e27e964ac169" }}
once_cell = "1.10.0"
...
#[test]
// Ignored because transactions require minting/transfering Coin<EndlessCoin>, which the
...
fn test_that_rust_entry_fun_code_compiles() {
    ...
    let abis = vec![];
    test_rust(
        &abis, // &endless_cached_packages::head_release_bundle().abis(),
