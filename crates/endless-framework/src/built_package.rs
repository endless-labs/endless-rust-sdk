...
use crate::{
    ...
    zip_metadata, zip_metadata_str, RuntimeModuleMetadataV1, ENDLESS_METADATA_KEY,
    ENDLESS_METADATA_KEY_V1, METADATA_V1_MIN_FILE_FORMAT_VERSION,
};
use anyhow::bail;
use clap::Parser;
...
use endless_types::{account_address::AccountAddress, transaction::EntryABI};
...
pub const ENDLESS_PACKAGES: [&str; 5] = [
    "EndlessFramework",
    "MoveStdlib",
    "EndlessStdlib",
    "EndlessToken",
                    ...
                    if !module_metadata.is_empty() {
                            ...
                            >= METADATA_V1_MIN_FILE_FORMAT_VERSION
                        {
                            ...
                            named_module.module.metadata.push(Metadata {
                                key: ENDLESS_METADATA_KEY_V1.to_vec(),
                            ...
                            let serialized_metadata =
                                bcs::to_bytes(&module_metadata.clone().downgrade())
                                    .expect("BCS for RuntimeModuleMetadata");
                            named_module.module.metadata.push(Metadata {
                                key: ENDLESS_METADATA_KEY.to_vec(),
                                value: serialized_metadata,
                            });
                        }
