...
use clap::Parser;
use endless_framework::{ReleaseOptions, ReleaseTarget};

#[derive(Parser)]
#[clap(name = "endless-framework", author, version, propagate_version = true)]
enum Commands {
    /// Creates an Endless framework release for the specified target.
