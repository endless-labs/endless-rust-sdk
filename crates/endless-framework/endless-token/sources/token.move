...
module endless_token::token {
    ...
    use std::signer;
    use std::vector;
    use endless_framework::aggregator_v2::{Self, AggregatorSnapshot, DerivedStringSnapshot};
    use endless_framework::event;
    use endless_framework::object::{Self, ConstructorRef, Object};
    use endless_std::string_utils::{to_string};
    use endless_token::collection::{Self, Collection};
    use endless_token::royalty::{Self, Royalty};

    #[test_only]
    use endless_framework::object::ExtendRef;
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x20002, location = endless_token::collection)]
