/// `PropertyMap` provides generic metadata support for `EndlessToken`. It is a specialization of
...
module endless_token::property_map {
    use std::bcs;
    use std::vector;
    use std::error;
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x10001, location = endless_std::from_bcs)]
