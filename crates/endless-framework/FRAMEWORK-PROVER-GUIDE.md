This guide gives some hints to troubleshoot issues when using the prover for specifying the Endless frameworks.

## Installation

Please refer to the [doc](https://docs.endless.link/endless/devbuild/build/endless-cli/install-move-prover).
...
you could use the command `cargo test --release -p endless-framework -- --skip prover`.