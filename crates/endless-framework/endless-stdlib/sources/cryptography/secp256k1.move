...
module endless_std::secp256k1 {
    ...
    fun test_ecdsa_recover() {
        ...
        let pk = ecdsa_recover(
            hash::sha2_256(b"test endless secp256k1"),
            0,
            &ECDSASignature { bytes: x"740bed225c07e3a2b845b7ba4818006b4411d0ad286b044e22860ed7efa2a4d12cf612065c5d9cd0d05a30992dafd93a2fdbbd1b78f14231250dd89894a8d382" },
        );
        ...
        let pk = ecdsa_recover(
            ...
            &ECDSASignature { bytes: x"f40bed225c07e3a2b845b7ba4818006b4411d0ad286b044e22860ed7efa2a4d12cf612065c5d9cd0d05a30992dafd93a2fdbbd1b78f14231250dd89894a8d382" },
        );
        assert!(std::option::is_some(&pk), 1);
        assert!(std::option::extract(&mut pk).bytes != x"4646ae5047316b4230d0086c8acec687f00b1cd9d1dc634f6cb358ac0a9a8ffffe77b4dd0a4bfb95851f3b7355c781dd60f8418fc8a65d14907aff47c903a559", 1);
        ...
        let pk = ecdsa_recover(
            hash::sha2_256(b"test endless secp256k1"),
            0,
            &ECDSASignature { bytes: x"750bed225c07e3a2b845b7ba4818006b4411d0ad286b044e22860ed7efa2a4d12cf612065c5d9cd0d05a30992dafd93a2fdbbd1b78f14231250dd89894a8d382" },
        );
