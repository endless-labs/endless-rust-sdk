...
module endless_std::ristretto255_bulletproofs {
    use std::error;
    use std::features;
    use endless_std::ristretto255_pedersen as pedersen;
    use endless_std::ristretto255::{Self, RistrettoPoint};
    ...
    #[test_only]
    use endless_std::ristretto255::{Scalar, scalar_to_bytes};

    #[test_only]
    const A_DST: vector<u8> = b"EndlessBulletproofs";
    #[test_only]
