...
/// a general conversion back-and-force is needed, consider the `endless_std::Any` type which preserves invariants.
///
/// Example:
/// ```
/// use std::bcs;
...
module endless_std::from_bcs {
    ...
    friend endless_std::any;
    friend endless_std::copyable_any;
