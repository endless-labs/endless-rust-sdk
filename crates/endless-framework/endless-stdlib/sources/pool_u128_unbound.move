...
/// shares left.
///
module endless_std::pool_u128_unbound {
    use endless_std::table_with_length::{Self as table, TableWithLength as Table};
    use std::error;
    ...
    public fun create_with_scaling_factor(scaling_factor: u128): Pool {
        Pool {
            total_coins: 0,
            total_shares: 0,
