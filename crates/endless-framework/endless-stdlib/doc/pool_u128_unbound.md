...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_new">new</a>(): <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a> {
    // Default <b>to</b> a scaling factor of 1 (effectively no scaling).
    <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_create_with_scaling_factor">create_with_scaling_factor</a>(1)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_create_with_scaling_factor">create_with_scaling_factor</a>(scaling_factor: u128): <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a> {
    <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a> {
        total_coins: 0,
        total_shares: 0,
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_destroy_empty">destroy_empty</a>(pool: <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>) {
    <b>assert</b>!(pool.total_coins == 0, <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_state">error::invalid_state</a>(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_EPOOL_IS_NOT_EMPTY">EPOOL_IS_NOT_EMPTY</a>));
    <b>let</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a> {
        total_coins: _,
        total_shares: _,
        shares,
        scaling_factor: _,
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_total_coins">total_coins</a>(pool: &<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>): u128 {
    pool.total_coins
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_total_shares">total_shares</a>(pool: &<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>): u128 {
    pool.total_shares
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_contains">contains</a>(pool: &<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>, shareholder: <b>address</b>): bool {
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_shares">shares</a>(pool: &<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>, shareholder: <b>address</b>): u128 {
    <b>if</b> (<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_contains">contains</a>(pool, shareholder)) {
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_balance">balance</a>(pool: &<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>, shareholder: <b>address</b>): u128 {
    <b>let</b> num_shares = <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_shares">shares</a>(pool, shareholder);
    <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_shares_to_amount">shares_to_amount</a>(pool, num_shares)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_shareholders_count">shareholders_count</a>(pool: &<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>): u64 {
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_update_total_coins">update_total_coins</a>(pool: &<b>mut</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>, new_total_coins: u128) {
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_buy_in">buy_in</a>(pool: &<b>mut</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>, shareholder: <b>address</b>, coins_amount: u128): u128 {
    <b>if</b> (coins_amount == 0) <b>return</b> 0;

    <b>let</b> new_shares = <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_amount_to_shares">amount_to_shares</a>(pool, coins_amount);
    <b>assert</b>!(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_MAX_U128">MAX_U128</a> - pool.total_coins &gt;= coins_amount, <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_EPOOL_TOTAL_COINS_OVERFLOW">EPOOL_TOTAL_COINS_OVERFLOW</a>));
    <b>assert</b>!(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_MAX_U128">MAX_U128</a> - pool.total_shares &gt;= new_shares, <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_EPOOL_TOTAL_SHARES_OVERFLOW">EPOOL_TOTAL_SHARES_OVERFLOW</a>));

    pool.total_coins = pool.total_coins + coins_amount;
    pool.total_shares = pool.total_shares + new_shares;
    <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_add_shares">add_shares</a>(pool, shareholder, new_shares);
    new_shares
}
</code></pre>
...
<pre><code><b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_add_shares">add_shares</a>(pool: &<b>mut</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>, shareholder: <b>address</b>, new_shares: u128): u128 {
    <b>if</b> (<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_contains">contains</a>(pool, shareholder)) {
        ...
        <b>assert</b>!(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_MAX_U128">MAX_U128</a> - current_shares &gt;= new_shares, <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_ESHAREHOLDER_SHARES_OVERFLOW">ESHAREHOLDER_SHARES_OVERFLOW</a>));
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_redeem_shares">redeem_shares</a>(pool: &<b>mut</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>, shareholder: <b>address</b>, shares_to_redeem: u128): u128 {
    <b>assert</b>!(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_contains">contains</a>(pool, shareholder), <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_ESHAREHOLDER_NOT_FOUND">ESHAREHOLDER_NOT_FOUND</a>));
    <b>assert</b>!(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_shares">shares</a>(pool, shareholder) &gt;= shares_to_redeem, <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_EINSUFFICIENT_SHARES">EINSUFFICIENT_SHARES</a>));

    <b>if</b> (shares_to_redeem == 0) <b>return</b> 0;

    <b>let</b> redeemed_coins = <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_shares_to_amount">shares_to_amount</a>(pool, shares_to_redeem);
    pool.total_coins = pool.total_coins - redeemed_coins;
    pool.total_shares = pool.total_shares - shares_to_redeem;
    <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_deduct_shares">deduct_shares</a>(pool, shareholder, shares_to_redeem);
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_transfer_shares">transfer_shares</a>(
    pool: &<b>mut</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>,
    shareholder_1: <b>address</b>,
    shareholder_2: <b>address</b>,
    shares_to_transfer: u128,
) {
    <b>assert</b>!(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_contains">contains</a>(pool, shareholder_1), <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_ESHAREHOLDER_NOT_FOUND">ESHAREHOLDER_NOT_FOUND</a>));
    <b>assert</b>!(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_shares">shares</a>(pool, shareholder_1) &gt;= shares_to_transfer, <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_EINSUFFICIENT_SHARES">EINSUFFICIENT_SHARES</a>));
    <b>if</b> (shares_to_transfer == 0) <b>return</b>;

    <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_deduct_shares">deduct_shares</a>(pool, shareholder_1, shares_to_transfer);
    <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_add_shares">add_shares</a>(pool, shareholder_2, shares_to_transfer);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_deduct_shares">deduct_shares</a>(pool: &<b>mut</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>, shareholder: <b>address</b>, num_shares: u128): u128 {
    <b>assert</b>!(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_contains">contains</a>(pool, shareholder), <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_ESHAREHOLDER_NOT_FOUND">ESHAREHOLDER_NOT_FOUND</a>));
    <b>assert</b>!(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_shares">shares</a>(pool, shareholder) &gt;= num_shares, <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_EINSUFFICIENT_SHARES">EINSUFFICIENT_SHARES</a>));
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_amount_to_shares">amount_to_shares</a>(pool: &<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>, coins_amount: u128): u128 {
    <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_amount_to_shares_with_total_coins">amount_to_shares_with_total_coins</a>(pool, coins_amount, pool.total_coins)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_amount_to_shares_with_total_coins">amount_to_shares_with_total_coins</a>(pool: &<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>, coins_amount: u128, total_coins: u128): u128 {
    ...
    <b>if</b> (pool.total_coins == 0 || pool.total_shares == 0) {
        ...
        <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_multiply_then_divide">multiply_then_divide</a>(pool, coins_amount, pool.total_shares, total_coins)
    }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_shares_to_amount">shares_to_amount</a>(pool: &<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>, shares: u128): u128 {
    <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_shares_to_amount_with_total_coins">shares_to_amount_with_total_coins</a>(pool, shares, pool.total_coins)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_shares_to_amount_with_total_coins">shares_to_amount_with_total_coins</a>(pool: &<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>, shares: u128, total_coins: u128): u128 {
    ...
    <b>if</b> (pool.total_coins == 0 || pool.total_shares == 0) {
        ...
        // We rearrange the calc and do multiplication first <b>to</b> avoid rounding errors.
        <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_multiply_then_divide">multiply_then_divide</a>(pool, shares, total_coins, pool.total_shares)
    }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_shares_to_amount_with_total_stats">shares_to_amount_with_total_stats</a>(
    pool: &<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>,
    shares: u128,
    total_coins: u128,
    total_shares: u128,
): u128 {
    <b>if</b> (pool.total_coins == 0 || total_shares == 0) {
        ...
        <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_multiply_then_divide">multiply_then_divide</a>(pool, shares, total_coins, total_shares)
    }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_multiply_then_divide">multiply_then_divide</a>(_pool: &<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_Pool">Pool</a>, x: u128, y: u128, z: u128): u128 {
    <b>let</b> result = (<a href="pool_u128_unbound.md#0x1_pool_u128_unbound_to_u256">to_u256</a>(x) * <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_to_u256">to_u256</a>(y)) / <a href="pool_u128_unbound.md#0x1_pool_u128_unbound_to_u256">to_u256</a>(z);
    (result <b>as</b> u128)
}
</code></pre>
