spec endless_framework::code {
    ...
    /// Enforcement: The Endless upgrade native functions have been manually audited.
    ///
    /// No.: 2
    ...
    spec initialize(endless_framework: &signer, package_owner: &signer, metadata: PackageMetadata) {
