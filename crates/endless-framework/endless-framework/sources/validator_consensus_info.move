...
module endless_framework::validator_consensus_info {
    ...
    public fun new(addr: address, pk_bytes: vector<u8>, voting_power: u128): ValidatorConsensusInfo {
        ValidatorConsensusInfo {
            addr,
            pk_bytes,
            voting_power,
    ...
    public fun get_voting_power(vci: &ValidatorConsensusInfo): u128 {
        vci.voting_power
    }
}
