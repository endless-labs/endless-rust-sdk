spec endless_framework::staking_proxy {
    /// <high-level-req>
    /// No.: 1
    ...
    /// Enforcement: Enforced via [https://github.com/Endless-labs/endless/blob/main/endless-move/framework/endless-framework/sources/staking_contract.move#L87](SimpleMap).
    /// </high-level-req>
    ///
    spec module {
        pragma verify = true;
    ...
    spec schema SetStakingContractOperator {
        ...
        use endless_framework::staking_contract::{Store};
