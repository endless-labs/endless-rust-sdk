...
module endless_framework::object_code_deployment {
    use std::bcs;
    use std::error;
    use std::features;
    use std::signer;
    ...
    use endless_framework::code;
    use endless_framework::code::PackageRegistry;
    use endless_framework::event;
    use endless_framework::object;
    use endless_framework::object::{ExtendRef, Object};
    ...
    const OBJECT_CODE_DEPLOYMENT_DOMAIN_SEPARATOR: vector<u8> = b"endless_framework::object_code_deployment";
