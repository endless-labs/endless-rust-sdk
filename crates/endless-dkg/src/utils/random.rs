...
/// ```
///
/// But we can't due to `endless-crypto`'s dependency on an older version of `rand` and `rand_core`
...
pub const DST_RAND_CORE_HELL: &[u8; 26] = b"ENDLESS_RAND_CORE_HELL_DST";
