...
use endless_crypto::{bls12381, CryptoMaterialError, Genesis, SigningKey, ValidCryptoMaterial};
...
const DAS_WEIGHTED_PVSS_FIAT_SHAMIR_DST: &[u8; 50] =
    b"ENDLESS_DAS_WEIGHTED_PROVABLY_PVSS_FIAT_SHAMIR_DST";
