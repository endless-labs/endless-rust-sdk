...
use endless_crypto::{CryptoMaterialError, ValidCryptoMaterial, ValidCryptoMaterialStringExt};
use endless_crypto_derive::{DeserializeKey, SerializeKey};
...
pub const DST_PVSS_PUBLIC_PARAMS: &[u8; 34] = b"ENDLESS_DISTRIBUTED_RANDOMNESS_DST";
/// "Nothing up my sleeve" seed to deterministically-derive the public parameters.
pub const SEED_PVSS_PUBLIC_PARAMS: &[u8; 35] = b"ENDLESS_DISTRIBUTED_RANDOMNESS_SEED";
...
impl Default for PublicParameters {
    /// Verifiably creates Endless-specific public parameters.
    fn default() -> Self {
