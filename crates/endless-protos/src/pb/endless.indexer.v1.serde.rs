...
impl serde::Serialize for GetTransactionsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("endless.indexer.v1.GetTransactionsRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for GetTransactionsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct endless.indexer.v1.GetTransactionsRequest")
            }
        ...
        deserializer.deserialize_struct("endless.indexer.v1.GetTransactionsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for RawTransactionsResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("endless.indexer.v1.RawTransactionsResponse", len)?;
        if !self.transactions.is_empty() {
...
impl<'de> serde::Deserialize<'de> for RawTransactionsResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = RawTransactionsResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct endless.indexer.v1.RawTransactionsResponse")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<RawTransactionsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(RawTransactionsResponse {
                    transactions: transactions__.unwrap_or_default(),
                    chain_id: chain_id__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("endless.indexer.v1.RawTransactionsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TransactionsInStorage {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("endless.indexer.v1.TransactionsInStorage", len)?;
        if !self.transactions.is_empty() {
            struct_ser.serialize_field("transactions", &self.transactions)?;
        }
        if let Some(v) = self.starting_version.as_ref() {
...
impl<'de> serde::Deserialize<'de> for TransactionsInStorage {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct endless.indexer.v1.TransactionsInStorage")
            }
        ...
        deserializer.deserialize_struct("endless.indexer.v1.TransactionsInStorage", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TransactionsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("endless.indexer.v1.TransactionsResponse", len)?;
        if !self.transactions.is_empty() {
            struct_ser.serialize_field("transactions", &self.transactions)?;
        }
...
impl<'de> serde::Deserialize<'de> for TransactionsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct endless.indexer.v1.TransactionsResponse")
            }
        ...
        deserializer.deserialize_struct("endless.indexer.v1.TransactionsResponse", FIELDS, GeneratedVisitor)
    }
}
