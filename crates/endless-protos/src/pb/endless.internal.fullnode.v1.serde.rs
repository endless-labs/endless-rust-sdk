...
impl serde::Serialize for GetTransactionsFromNodeRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("endless.internal.fullnode.v1.GetTransactionsFromNodeRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for GetTransactionsFromNodeRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct endless.internal.fullnode.v1.GetTransactionsFromNodeRequest")
            }
        ...
        deserializer.deserialize_struct("endless.internal.fullnode.v1.GetTransactionsFromNodeRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for StreamStatus {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("endless.internal.fullnode.v1.StreamStatus", len)?;
        if self.r#type != 0 {
...
impl<'de> serde::Deserialize<'de> for StreamStatus {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct endless.internal.fullnode.v1.StreamStatus")
            }
        ...
        deserializer.deserialize_struct("endless.internal.fullnode.v1.StreamStatus", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for TransactionsFromNodeResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("endless.internal.fullnode.v1.TransactionsFromNodeResponse", len)?;
        if self.chain_id != 0 {
...
impl<'de> serde::Deserialize<'de> for TransactionsFromNodeResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct endless.internal.fullnode.v1.TransactionsFromNodeResponse")
            }
...
;
        ...
        deserializer.deserialize_struct("endless.internal.fullnode.v1.TransactionsFromNodeResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TransactionsOutput {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("endless.internal.fullnode.v1.TransactionsOutput", len)?;
        if !self.transactions.is_empty() {
...
impl<'de> serde::Deserialize<'de> for TransactionsOutput {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct endless.internal.fullnode.v1.TransactionsOutput")
            }
        ...
        deserializer.deserialize_struct("endless.internal.fullnode.v1.TransactionsOutput", FIELDS, GeneratedVisitor)
    }
}
